    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li class="active">
            <a href="http://internet-shop.tmweb.ru">Все товары</a>
          </li>
          <li >
            <a href="http://internet-shop.tmweb.ru/categories">Категории</a>
          </li>
          <li >
            <a href="http://internet-shop.tmweb.ru/basket">В корзину</a>
          </li>
          <li>
                  ...
                  <div class="caption">
                    ...
                    <p>
                      <form action="http://internet-shop.tmweb.ru/basket/add/1" method="POST">
                        ...
                        <input type="hidden" name="_token" value="lZcJMl44K03tENEgzEh3hydGNXPPR2KpW7nfWOO1">
                      </form>
                    </p>
                  </div>
                </div>
